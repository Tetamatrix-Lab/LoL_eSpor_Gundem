...
public class KoreaLig extends ActionBarActivity {
    private String urlJsonObj = "https://www.kimonolabs.com/api/3efx3jo4?apikey=ISzQZSJvnwslwuRxxGRyqUvPXPP3pwoi";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                          /*String at1= response.getString("name");
                        	...
                        	toString at5 = response.getString("newdata");
