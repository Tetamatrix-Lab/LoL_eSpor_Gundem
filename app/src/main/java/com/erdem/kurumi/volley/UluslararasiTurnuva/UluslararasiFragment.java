package com.erdem.kurumi.volley.UluslararasiTurnuva;
 ...
 */
public class UluslararasiFragment extends Fragment {
    private static final String TAG = "YouTubeFragment";

    private static final String YOUTUBE_PLAYLIST = "PLLeGGUvlzUaLcig3rZm5TxlivF0h7M5wU";
