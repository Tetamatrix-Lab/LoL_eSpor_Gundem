...
public class KDAadapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<Movie2> movieItems;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public KDAadapter(Activity activity, List<Movie2> movieItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView rating = (TextView) convertView.findViewById(R.id.rating);//Kda oranı
        TextView year = (TextView) convertView.findViewById(R.id.releaseYear);//Oyuncunu takımı
