package com.erdem.kurumi.volley.YukselmeLigi;
 ...
 */
public class YukselmeFragment extends Fragment {
    private static final String TAG = "YouTubeFragment";

    private static final String YOUTUBE_PLAYLIST = "PLLeGGUvlzUaI00PKpO-FvqapGTOXR5v7v";
