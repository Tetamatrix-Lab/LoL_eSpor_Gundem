...
public class YukselmePuan extends ActionBarActivity {
    private String urlJsonObj = "https://www.kimonolabs.com/api/86teqamk?apikey=ISzQZSJvnwslwuRxxGRyqUvPXPP3pwoi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeJsonObjectRequest();//Metodun ba�lamas�n� sa�layan ca��rma
    }
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray collection1 = results.getJSONArray("collection1");//Json array� se�tik

                    for (int i = 0; i < collection1.length(); i++) {
                        JSONObject result11 = collection1.getJSONObject(i);//t�m json nesnelerini al�r

                        //Nesne olu�turduk title� set ettik
                        //Field da tan�mlarsan birkere obje olu�turur yani tek takim olur
