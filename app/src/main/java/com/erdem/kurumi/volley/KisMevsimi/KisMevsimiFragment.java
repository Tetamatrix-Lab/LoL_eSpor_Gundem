package com.erdem.kurumi.volley.KisMevsimi;
 ...
 */
public class KisMevsimiFragment extends Fragment {
    private static final String TAG = "YouTubeFragment";

    private static final String YOUTUBE_PLAYLIST = "PLLeGGUvlzUaJHxXNlMPhupFHeqWoQp4YH";
