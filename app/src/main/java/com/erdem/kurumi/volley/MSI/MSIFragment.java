package com.erdem.kurumi.volley.MSI;
 ...
 */
public class MSIFragment extends Fragment {
    private static final String TAG = "YouTubeFragment";

    private static final String YOUTUBE_PLAYLIST = "PLLeGGUvlzUaLESnuG5uAakQGSBV4edJtX";
