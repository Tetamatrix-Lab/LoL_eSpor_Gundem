package com.erdem.kurumi.volley.SampiyonlukLigiOzet;
...
import com.erdem.kurumi.volley.BuildConfig;
import com.erdem.kurumi.volley.Youtube.GetYouTubePlaylistAsyncTask;
import com.erdem.kurumi.volley.Youtube.GetYouTubeVideoAsyncTask;
import com.erdem.kurumi.volley.Youtube.Izle;
import com.erdem.kurumi.volley.Youtube.Playlist;
import com.erdem.kurumi.volley.Youtube.PlaylistItem;
...
public class YouTubeFragment extends Fragment {
    ...
    private static final String YOUTUBE_PLAYLIST = "PLLeGGUvlzUaIt_SiHcm6kRyp6McmVh5SS";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        }.execute(getYoutubePlaylist(), null);
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            viewHolder.thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(getActivity(), Izle.class);
            ...
            if (!isEmpty(nextPageToken) && position == getCount() - 1) {
                ...
                }.execute(getYoutubePlaylist(), nextPageToken);
