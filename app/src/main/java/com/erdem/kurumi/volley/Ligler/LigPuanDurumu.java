...
public class LigPuanDurumu extends ActionBarActivity {
    //Reklam alanı tanımlamarı
    private String urlJsonObj = "https://www.kimonolabs.com/api/2nd239l2?apikey=ISzQZSJvnwslwuRxxGRyqUvPXPP3pwoi";
